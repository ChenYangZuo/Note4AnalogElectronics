...
![image-20220313174649143](pic/image-20220313174649143.png)

#### 2.分析

$u_O=+U_Z$时，$U_P=+U_T$，$U_O$经过$R_3$对C充电

当$u_N=+U_T$时，$u_O=-U_Z$，$u_P=-U_T$，C经过$R_3$放电

当$u_N=-U_T$时，$u_O=+U_Z$，$u_P=+U_T$

$\Large T=2R_3Cln(1+{2R_1 \over R_2})$

### 二、可调占空比电路

![image-20220313181821555](pic/image-20220313181821555.png)

## 6.3.2 三角波发生电路

### 1.结构

![image-20220314105701373](pic/image-20220314105701373.png)

### 2.分析

![image-20220314112435030](pic/image-20220314112435030.png)

$\Large u_{P1}={R_2 \over R_1+R_2}u_O+{R_1 \over R_1+R_2}u_{O1}={R_2 \over R_1+R_2}u_O \pm {R_1 \over R_1+R_2}U_Z$

当$\large u_{P1}=u_{N1}=0$时，$\large \pm U_T=\pm {R_1 \over R_2}U_Z$

$\Large T_K={(U_{T+}-U_{T-})C \over i_C} = {2U_Z{R_1 \over R_2}C \over {U_{O1} \over R_3}} = 2{R_1R_3 \over R_2}C$

$\Large T=2T_K=4{R_1R_3 \over R_2}C$

## 6.3.3 锯齿波发生电路

### 结构

![image-20220314154236714](pic/image-20220314154236714.png)
